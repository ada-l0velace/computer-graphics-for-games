...
Figure::Figure(const cgj::Vector3& pos, float rotation, cgj::Vector3 scale) {
    m_transform = cgj::MatrixFactory::translate(pos)*
    cgj::MatrixFactory::rotate(rotation, cgj::MatrixFactory::z_axis)*
    cgj::MatrixFactory::scale(scale);
